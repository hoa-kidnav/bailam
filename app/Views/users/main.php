...
<html lang="en">
   ...
   <?= base_url()?>
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="assets/users/images/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" href="assets/users/images/apple-touch-icon.png">
    ...
    <!-- ALL VERSION CSS -->
    <link rel="stylesheet" href="assets/users/css/versions.css">
    <!-- Responsive CSS -->
    <link rel="stylesheet" href="assets/users/css/responsive.css">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="assets/users/css/custom.css">
...
<body class="app_version" data-spy="scroll" data-target="#navbarApp" data-offset="98">
    ...
    <!-- ALL JS FILES -->
    <script src="assets/users/js/all.js"></script>
    <!-- ALL PLUGINS -->
    <script src="assets/users/js/custom.js"></script>
	<script src="assets/users/js/zenith.js"></script>
	<script>
		$('#default').zenith({
			layout: 'default' , 
			slideSpeed: 450, 
