<div class="dash-nav dash-nav-dark">
            <header>
                ...
                <a href="index.html" class="easion-logo"><i class="fas fa-sun"></i> <span></span>Admin</a>
            </header>
            <nav class="dash-nav-list">
                ...
                <div class="dash-nav-dropdown">
                    ...
                    <div class="dash-nav-dropdown-menu">
                        <a href="user/list" class="dash-nav-dropdown-item">Danh sách</a>
                        <a href="user/add" class="dash-nav-dropdown-item">Thêm mới</a>
                    </div>
                </div>
                <div class="dash-nav-dropdown">
                    <a href="javascript::void(0)" class="dash-nav-item dash-nav-dropdown-toggle">
